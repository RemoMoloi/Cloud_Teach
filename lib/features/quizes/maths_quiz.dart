...
import '../../models/db_connection/db_connect_maths.dart';
import '../../models/qModels/maths_model.dart';
...
var db = DBconnect();
late Future _questionsM;

Future<List<QuestionM>> getData() async {
 ...
 void direction(){
  Navigator.push(
    context,
     ...
     (context) => const MathsQuiz()
      ));
 }
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questionsM as Future<List<QuestionM>>,
      builder: (ctx, snapshot){
        if(snapshot.connectionState == ConnectionState.done){
          if(snapshot.hasError){
            ...
            var extractedData = snapshot.data as List<QuestionM>;
            return  Scaffold(
