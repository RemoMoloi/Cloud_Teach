...
import '../../models/db_connection/db_connect_phy.dart';
import '../../models/qModels/physics_model.dart';
...
var db = DBconnectPS();
late Future _questionsPS;

Future<List<QuestionPS>> getData() async {
  return db.fetchQuestions();
}

@override
  void initState() {
    _questionsPS = getData();
    super.initState();
  }
 ...
 void direction(){
  Navigator.push(
    context,
     ...
     (context) => const PhysicsQuiz()
      ));
 }
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questionsPS as Future<List<QuestionPS>>,
      builder: (ctx, snapshot){
        if(snapshot.connectionState == ConnectionState.done){
          if(snapshot.hasError){
            ...
            var extractedData = snapshot.data as List<QuestionPS>;
            return  Scaffold(
